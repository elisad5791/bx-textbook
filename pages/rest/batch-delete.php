<h1>Пакетное удаление лидов</h1>

<p>Часто встает задача удаления большого количества каких-либо сущностей посредством rest. Для оптимизации процесса можно использовать пакетное выполнение запросов.</p>
...
<pre>
    <code>
        ...
        do {
            ...
            $batch['delete_' . $current] = ['method' => 'crm.lead.delete', 'params' => $params];
